...
//   ];
  ngOnInit(): void {
    ...
    this.isAdmin=localStorage.getItem("userId") == '1'? true:false;
  }

  // search(text:any){
  //   debugger
  //   this.products=JSON.parse(JSON.stringify(this.copy))
  // this.products = this.products.filter( ({ name }) => name.toLowerCase().startsWith(text.toLowerCase()))
